...
\begin{figure}[htbp]
    ...
    \caption{Visual representation of the Bounding Volume Hierarchy (BVH) structure. The ray only checks which box it hits, and then tests the triangles inside that hitted-box volume. The red triangle is the triangle being tested, and the green triangle is the closest hit. It reduces more than 90\% of the overall test triangles compared to a brute force approach.}
